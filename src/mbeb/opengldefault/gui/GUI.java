...
/**
 * A GUI that contains {@link GUIElement} that get rendered in one drawcall
 * 
 * @author Markus
 */
public class GUI implements IRenderable {
	...
	/**
	 * gui specific instaced vertex data buffer handle
	 */
	...
	/**
	 * Buffer data from the gui elements into the {@link #buffer}
	 */
	...
	/**
	 * Generate FloatBuffer using the GUIElements {@link GUIElement#writeToBuffer()}
	 * 
